classdef MyALGORITHM < handle & matlab.mixin.Heterogeneous
...
%--------------------------------------------------------------------------
    ...
    properties(SetAccess = protected)
        ...
        outputFcn = @NoOutput;          %nothing output function of ALGORITHM
        ...
        Archive = struct('dec', {}, 'obj', {});  % Archive for algorithms that need it
    end
    methods(Access = protected)
        function obj = MyALGORITHM(varargin)
...
function NoOutput(~,~)
    % Nothing output function of ALGORITHM
end
