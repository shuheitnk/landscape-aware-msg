classdef custom_CPDEA < MyALGORITHM
...
%--------------------------------------------------------------------------
    ...
    methods
        function main(Algorithm,Problem)
            ...
            targetPath = fullfile(thisFilePath, '..', 'CPDEA', 'CPDEA');
            ...
            while Algorithm.NotTerminated(Archive)             
                ...
                if sd > p && length(Archive) > K % second reproduction operator
                    ...
                    Offspring = OperatorGAhalf_real(Problem, Parents);          
                else % first reproduction operator
                    MatingPool = TournamentSelection(2,2,fCPD);
                    Offspring = OperatorGAhalf_real(Problem, Population(MatingPool));
                end
