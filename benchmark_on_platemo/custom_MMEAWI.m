classdef custom_MMEAWI < MyALGORITHM
...
% This function is written by Wenhua Li
    ...
    methods
        function main(Algorithm, Problem)
            ...
            targetPath = fullfile(thisFilePath, '..', 'PlatEMO', 'PlatEMO', 'Algorithms', 'Multi-objective optimization', 'MMEA-WI');
